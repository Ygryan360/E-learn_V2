...
<body>
    ...
    <header class="d-flex flex-wrap justify-content-center border-bottom p-3">
        <a href="{{ route('dashboard') }}"
            ...
            <span class="fs-4">E-Learn V2</span>
        </a>
        <ul class="navbar-nav flex-row d-md-none">
            <li class="nav-item text-nowrap">
                <button class="nav-link z-1 position-absolute dashboard_btn" type="button" data-bs-toggle="offcanvas"
                    ...
                    <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
                        <ul class="nav flex-column">
                            ...
                            @if (Auth::user()->role === 'teacher' || Auth::user()->role === 'admin')
                                <li class="nav-item">
                                    <a class="nav-link d-flex align-items-center gap-2 {{ request()->routeIs('course.create') ? 'active' : '' }}"
                                        aria-current="page" href="{{ route('course.create') }}">
                            ...
                            <ul class="nav flex-column mb-auto">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link d-flex align-items-center gap-2 {{ request()->routeIs('profile.edit') ? 'active' : '' }}"
