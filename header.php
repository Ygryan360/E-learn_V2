...
<html lang="fr">
  ...
  <body>
    ...
    <header class="d-flex flex-wrap justify-content-center p-3">
      <a href="/" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto m-2 link-body-emphasis text-decoration-none">
      ...
      <ul class="nav nav-pills">
        ...
        <li class="nav-item"><a href="./course.php" class="nav-link">Cours</a></li>
      </ul>
    </header>