...
<body>
    ...
    <header class="d-flex flex-wrap justify-content-center border-bottom p-3">
        ...
        <ul class="nav nav-pills">
            ...
            <li class="nav-item"><a href="./addcourse.php" class="nav-link">Ajouter un cours</a></li>
        </ul>
        <ul class="navbar-nav flex-row d-md-none">
            <li class="nav-item text-nowrap">
                <button class="nav-link z-1 position-absolute dashboard_btn" type="button" data-bs-toggle="offcanvas" data-bs-target="#sidebarMenu"
